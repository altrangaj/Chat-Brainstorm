...
import bg from './testi11.png'
import bg2 from './testi12.png'
		...
		return (
			<div>
				...
				<div style={{position:'absolute',bottom:'2em',left:'2em'}}>
					<div style={{fontSize:'1.1em',float:'left',display:'inline',fontFamily: 'Orbitron, sans-serif',fontWeight:'700', color:'#ff794d',whiteSpace: 'nowrap',backgroundColor:'rgba(0,0,0,0.5)',paddingTop:'0.2em', paddingBottom:'0.2em',paddingLeft:'0.5em',paddingRight:'0.5em',textShadow: '-1px 0 black, 0 1px black, 1px 0 black, 0 -1px black'}}>{props.user.username} is logged in </div>
				...
				<div style={{lineHeight:'1.2em',fontSize:'1em',textAlign:'center', position:'absolute',bottom:'2em',right:'3em',paddingLeft:'0.25em',paddingTop:'0.4em',paddingBottom:'0.25em',paddingRight:'0.5em',fontFamily: 'Orbitron, sans-serif',fontWeight:'700', color:'#ff794d',whiteSpace: 'nowrap',backgroundColor:'rgba(0,0,0,0.5)',textShadow: '-1px 0 black, 0 1px black, 1px 0 black, 0 -1px black'}}>
